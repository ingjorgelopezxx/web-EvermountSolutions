...
INFO_INSECTOS = {
    ...
    "aves_otros": {
        ...
        "descripcion": "Controlamos también otras especies invasoras que puedan causar daños, adaptando el sistema de control a cada situación para proteger la estructura y la salud de las personas.",
    },
}
        ...
        if isinstance(parrafo, dict) and parrafo.get("tipo") == "clickable_row":
            ...
            for item in parrafo.get("items", []):
                ...
                cont = ft.Container(
                    ...
                    shadow=ft.BoxShadow(1, 6, ft.Colors.BLACK_26, offset=ft.Offset(2, 2)),
            ...
            controls.append(ft.Row(row_controles, alignment=ft.MainAxisAlignment.CENTER, spacing=7))
        else:
